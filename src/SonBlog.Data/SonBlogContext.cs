...
using SonBlog.Core.Domain.Identity;

namespace SonBlog.Data
{
    public class SonBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public SonBlogContext(DbContextOptions options) : base(options)
        {
        }
